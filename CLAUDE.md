...
- Supporting technical evidence appears in one tabbed `Evidence` section with four selectable charts in this order: Price structure, Momentum, Relative strength, and Fibonacci. The Fibonacci tab must visibly render the validated six-month close series, swing high and low, 38.2%, 50%, and 61.8% retracement levels, the current-price interaction, and one concise decision implication.
